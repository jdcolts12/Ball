-- Run this in Supabase → SQL Editor to enable weekly badges on every player's profile.
-- Returns correct, total, pct for the current PST week (Sunday–Saturday) for any user.
