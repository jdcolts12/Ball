-- SIMPLE DIRECT FIX - No CTEs, just straightforward query
...
comment on function public.get_daily_leaderboard(int) is 'Simple direct query - returns ALL users who played today.';
